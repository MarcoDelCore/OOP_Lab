 ...
 */
public class Food {
	private SortedMap<String, NutritionalElement> rawMaterial = new TreeMap<>();
	...
	public void defineRawMaterial(String name, double calories, double proteins, double carbs, double fat) {
		RawMaterial tmp = new RawMaterial(name, calories, proteins, carbs, fat, true);
		rawMaterial.put(name, tmp);
	}
	...
	public void defineProduct(String name, double calories, double proteins, double carbs, double fat) {
		Product tmp = new Product(name, calories, proteins, carbs, fat, false);
		products.put(name, tmp);
	}
